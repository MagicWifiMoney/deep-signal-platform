    ...
    switch (step) {
      ...
      case 7:
        if (deployDone && deployment) {
          const agentUrl = `/chat?domain=${encodeURIComponent(deployment.domain)}&token=${encodeURIComponent(deployment.gatewayToken)}&name=${encodeURIComponent(form.agentName)}`;
