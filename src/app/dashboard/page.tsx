          ...
          {!loading && instances.length > 0 && (
            <div className="space-y-3">
              {instances.map((inst) => (
                <div
                  key={inst.id}
                  className="rounded-xl border border-slate-700 bg-slate-800/30 p-5 flex items-center justify-between"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-medium text-white">{inst.hostname || inst.domain}</div>
                      <div className="text-xs text-slate-500 font-mono mt-0.5">{inst.domain} · {inst.ip}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 rounded-lg bg-cyan-500/20 border border-cyan-500/30 text-cyan-400 text-sm font-medium hover:bg-cyan-500/30 transition-colors"
                    >
                      Open Dashboard →
                    </a>
                  </div>
